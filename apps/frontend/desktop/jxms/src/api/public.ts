...
export const login = async (data: LoginData): Promise<any> => await requestes.Post('/admin/login', data)
export const logout = async (): Promise<any> => await requestes.Post('/admin/logout')
