const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/remoteEntry-CizHAr30.js"])))=>i.map(i=>d[i]);
...
let __tla = (async () => {
  ...
  i = async function() {
    return r || (r = (async () => {
      let t2 = await (await e(() => import("./remoteEntry-CizHAr30.js").then(async (m) => {
        await m.__tla;
        return m;
      }), __vite__mapDeps([0]))).init(), r2 = {
        vue: {
          shareConfig: {
            singleton: true,
