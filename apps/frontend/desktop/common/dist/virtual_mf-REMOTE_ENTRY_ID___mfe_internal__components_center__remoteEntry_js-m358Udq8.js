...
let __tla = (async () => {
  ...
  function te(e2, t2 = {}) {
    ...
    Object.keys(n2).length || (c2 = ((_a2 = e2.remotes) == null ? void 0 : _a2.reduce((e3, t3) => {
...
`);
  ...
  function De(e2) {
    ...
    }), w(e2, `__VMOK__`, e2.__FEDERATION__)), (_a2 = e2.__FEDERATION__).__GLOBAL_PLUGIN__ ?? (_a2.__GLOBAL_PLUGIN__ = []), (_b2 = e2.__FEDERATION__).__INSTANCES__ ?? (_b2.__INSTANCES__ = []), (_c = e2.__FEDERATION__).moduleInfo ?? (_c.moduleInfo = {}), (_d = e2.__FEDERATION__).__SHARE__ ?? (_d.__SHARE__ = {}), (_e2 = e2.__FEDERATION__).__MANIFEST_LOADING__ ?? (_e2.__MANIFEST_LOADING__ = {}), (_f = e2.__FEDERATION__).__PRELOADED_MAP__ ?? (_f.__PRELOADED_MAP__ = /* @__PURE__ */ new Map());
  }
  De(x), De(S);
  function Oe(e2) {
  ...
  function Et(e2, t2, n2, r2) {
    ...
    }), ((_a2 = e2.shareConfig) == null ? void 0 : _a2.eager) && ((_b2 = e2.treeShaking) == null ? void 0 : _b2.mode) && y(`Invalid shared config for "${n2}" from "${t2}": cannot use both "eager: true" and "treeShaking.mode" simultaneously. Choose one strategy.`), {
      deps: [],
      useIn: [],
      from: t2,
      loading: null,
  ...
  function J(e2) {
    ...
    for (let [n2, r2] of Object.entries(e2.shared)) {
      ...
      e3 && (t2[n2] = {
        version: e3.version,
        singleton: (_a2 = e3.shareConfig) == null ? void 0 : _a2.singleton,
        requiredVersion: ((_b2 = e3.shareConfig) == null ? void 0 : _b2.requiredVersion) === false ? false : (_c = e3.shareConfig) == null ? void 0 : _c.requiredVersion,
        eager: e3.eager,
 ...
 ${p(this.remoteInfo)}`), this.remoteEntryExports = e2, this.remoteEntryExports;
  ...
  var Z = class extends Y {
    ...
    applyPlugin(e2, t2) {
      ...
      let n2 = e2.name;
      v(n2, `A name must be provided by the plugin.`), this.registerPlugins[n2] || (this.registerPlugins[n2] = e2, (_a2 = e2.apply) == null ? void 0 : _a2.call(e2, t2), Object.keys(this.lifecycle).forEach((t3) => {
        let n3 = e2[t3];
  ...
  function wn(e2, t2, n2, r2, i2) {
    ...
    if (Sn(r2, n2, (t3, n3, r3) => {
      ...
      u3.length && `modules` in t3 && (l3 = (_a2 = t3 == null ? void 0 : t3.modules) == null ? void 0 : _a2.reduce((e3, t4) => ((u3 == null ? void 0 : u3.indexOf(t4.moduleName)) !== -1 && e3.push(t4), e3), []));
      function m3(e3) {
      ...
      i2.shared.forEach((e3) => {
        var _a2;
        let n3 = (_a2 = u2.shared) == null ? void 0 : _a2[e3.sharedName];
        if (!n3) return;
  ...
  var Dn = class {
        ...
        n2[e3].forEach((n3) => {
          n3.scope.forEach((r3) => {
            ...
            this.hooks.lifecycle.beforeRegisterShare.emit({
              ...
              pkgName: e3,
              shared: n3
            }), ((_a2 = this.shareScopeMap[r3]) == null ? void 0 : _a2[e3]) || this.setShared({
              pkgName: e3,
              lib: n3.lib,
              get: n3.get,
    ...
    initializeSharing(e2 = L, t2) {
      ...
      let l2 = s2[e2], u2 = (e3, t3) => {
        ...
        l2[e3] = l2[e3] || {};
        let i3 = l2[e3], a3 = i3[n3] && G(i3[n3]), o3 = !!(a3 && (`eager` in a3 && a3.eager || `shareConfig` in a3 && ((_a2 = a3.shareConfig) == null ? void 0 : _a2.eager)));
    ...
    registerRemote(e2, t2, n2) {
      let { host: r2 } = this, i2 = () => {
        if (e2.alias) {
          let n3 = t2.find((t3) => {
            var _a2;
            return e2.alias && (t3.name.startsWith(e2.alias) || ((_a2 = t3.alias) == null ? void 0 : _a2.startsWith(e2.alias)));
          });
    ...
    removeRemote(e2) {
      ...
      try {
        ...
        if (i2) {
          ...
          x[r3] && (((_a2 = Object.getOwnPropertyDescriptor(x, r3)) == null ? void 0 : _a2.configurable) ? delete x[r3] : x[r3] = void 0);
          ...
          if (s2 !== -1) {
            ...
            Object.keys(t3).forEach((e4) => {
              ...
              var _a3, _b2, _c;
              (_c = (_b2 = (_a3 = t3[e4]) == null ? void 0 : _a3[n4]) == null ? void 0 : _b2[r5]) == null ? true : delete _c[i4];
  ...
  Ae(jn), typeof __VUE_HMR_RUNTIME__ > `u` && (globalThis.__VUE_HMR_RUNTIME__ = {
    createRecord() {
    },
    rerender() {
    },
  ...
  var Ln = `__mf_init__virtual:mf:__mfe_internal__components_center__mf_v__runtimeInit__mf_v__.js__`, Rn = globalThis[Ln];
  if (!Rn) {
  ...
  var zn = Rn.initResolve, Bn = `__mf_module_cache__`;
  globalThis[Bn] || (globalThis[Bn] = {
    share: {},
    remote: {}
  }), (_a = globalThis[Bn]).share || (_a.share = {}), (_b = globalThis[Bn]).remote || (_b.remote = {});
  var Vn = globalThis[Bn], Hn = {}, Un = `default`, Wn = `__mfe_internal__components_center`, Gn, Kn;
  async function qn(e2) {
    for (let t2 = 0; ; t2++) try {
      return await e2();
    } catch (e3) {
      throw e3;
  ...
  async function Jn() {
    return Gn || (Gn = qn(() => e(() => import("./_virtual_mf-localSharedImportMap___mfe_internal__components_center-Dj-UPlAI.js").then(async (m2) => {
      await m2.__tla;
      return m2;
    }), [])).catch((e2) => {
      throw Gn = void 0, e2;
  ...
  async function Yn() {
    return Kn || (Kn = qn(() => e(() => import("./virtualExposes-CJf3jSNV.js").then(async (m2) => {
      await m2.__tla;
      return m2;
  ...
  Xn = async function(t2 = {}, n2 = []) {
    var _a2, _b2;
    let { usedShared: r2, usedRemotes: i2 } = await Jn();
    if (Vn.share.vue === void 0) {
      let t3 = await e(() => import("./_virtual_mf___mfe_internal__components_center__loadShare__vue__loadShare__.mjs-DlvFZDQ7.js").then(async (m2) => {
        await m2.__tla;
        return m2;
      }).then((e2) => e2.ct), []), n3 = ((e2) => {
        let t4 = e2;
        for (let e3 = 0; e3 < 5; e3++) {
          let e4 = t4 == null ? void 0 : t4.default;
          if (!e4 || typeof e4 != `object`) break;
          let n4 = Object.keys(t4).filter((e5) => e5 !== `default`).map((e5) => t4[e5]);
          if (n4.length > 0 && n4.some((e5) => e5 !== void 0)) break;
          t4 = e4;
        }
        return t4;
      })(t3), r3 = n3 === t3 ? {
    ...
    if (o2 || (o2 = Hn[Un] = {
      ...
      n2.push(o2), a2.initShareScopeMap(`default`, t2), zn(a2);
      try {
        await qn(async () => {
          await Promise.all(await a2.initializeSharing(`default`, {
      ...
      for (let [e2, n3] of Object.entries(r2)) {
        if (((_a2 = n3.shareConfig) == null ? void 0 : _a2.import) !== false || Vn.share[e2] !== void 0) continue;
        let r3 = (e3) => {
          let t3 = e3;
          ...
          return t3;
        }, i3 = t2 == null ? void 0 : t2[e2], a3 = i3 && i3[Object.keys(i3)[0]];
        if (!a3) continue;
        let o3 = a3.lib || (a3.loading ? await a3.loading : await ((_b2 = a3.get) == null ? void 0 : _b2.call(a3))), s2 = typeof o3 == `function` ? o3() : o3, c2 = await Promise.resolve(s2);
        Vn.share[e2] = r3(c2);
      }
      return a2;
    }
  };
  Zn = async function(e2) {
    let t2 = await Yn();
